    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            'flex flex-wrap items-center gap-1 overflow-hidden rounded-md border bg-background p-2 ring-ring ring-offset-2 ring-offset-background',
            {
              'focus-within:ring-2': activeIndex === -1,
            },
            className
          )}
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative flex items-center gap-1.5 truncate rounded-md p-2 py-1 aria-disabled:cursor-not-allowed aria-disabled:opacity-50 data-[active='true']:ring-2 data-[active='true']:ring-muted-foreground"
              )}
              variant={'secondary'}
            >
              ...
              >
                ...
                <RemoveIcon className="size-3.5 hover:stroke-destructive" />
              </button>
            </Badge>
          ))}
          <Input
